...
| Encoded | Bill | Score | Type | Title | Last Action | Link | Encode |
|:-------:|------|-------|------|-------|-------------|------|--------|
| :white_check_mark: | HB1001 | 95 | parametric | Reduce rate of income tax | Introduced 2026-02-10 | [LegiScan](url) | `/encode-bill GA HB1001` |
...
| Encoded | Bill | Score | Type | Title | Last Action | Link |
|:-------:|------|-------|------|-------|-------------|------|
...
The "Encoded" column uses `:white_check_mark:` if the bill exists in the `research` table (already encoded) and is left blank if not. This is determined by the cross-reference query in Step 7b.
