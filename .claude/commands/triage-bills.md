...
|---------|------|-------|------|-------|-------------|------|--------|
| - [x] | HB1001 | 95 | parametric | Reduce rate of income tax | Introduced 2026-02-10 | [LegiScan](url) | `/encode-bill GA HB1001` |
...
The "Encoded" column uses `- [x]` if the bill exists in the `research` table (already encoded) and `- [ ]` if not. This is determined by the cross-reference query in Step 7b.
